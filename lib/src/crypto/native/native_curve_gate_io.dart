...
/// Requires libsecp256k1 shared library at runtime.
class NativeCurveGateIo implements CurveGate {
  ...
  Future<void> load() async {
    // Would load libsecp256k1 via DynamicLibrary.open()
    // and initialize the context
    throw UnimplementedError(
        'Native FFI backend not yet built. Use SoftCurveGate instead.');
  }
